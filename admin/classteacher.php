<?php
    ...
    $teacherbyid = $rs['fname'].' '.$rs['midname'].' '.$rs['lname'];
            ...
            <div class="col-lg-12">
                <div class="alert alert-info">
                    <table>
                        ...
                        <tr>
                            <td width="100"><strong>INSTRUCTOR</strong></td>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a href="data/class_model.php?q=updateteacher&teachid=0<?php echo $row['id']; ?>&classid=<?php echo $classid;?>" class="btn btn-warning">Make as Instructor</a></td>
                                </tr>
                                <?php endwhile;?>

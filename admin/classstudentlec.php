<?php
    ...
    $studentsubject = $class->getstudentsubjectlec();
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="form-inline form-padding">
                    <form action="classstudentlec.php?classid=<?php echo $classid;?>" method="post">
                        ...
                        <a href="masterlist.php?classid=<?php echo $classid;?>" target="_blank" class="btn btn-primary">Master List</a>
                    </form>
                </div>
            </div>
        </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a href="data/class_model.php?q=addstudentlec&studid=<?php echo $row['id']; ?>&classid=<?php echo $classid;?>" class="btn btn-warning">Add to class</a></td>
                            
                                </tr>
                                <?php endwhile;?>
                                <?php if(mysql_num_rows($student) < 1): ?>
                                    <tr>
                                        <td colspan="12" class="text-center text-danger"><strong>*** NO RESULT ***</strong></td>
                                    </tr>
                                <?php endif;?>
                            </tbody>
                        </table>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['course']; ?></td>
                                    <td><?php echo $row['year']; ?></td>
                                    <td class="text-center"><a href="data/class_model.php?q=removestudentlec&studid=<?php echo $row['id']; ?>&classid=<?php echo $classid;?>" class="confirmation"><i class="fa fa-times-circle fa-2x text-danger"></i></a></td>
                                </tr>
                                <?php endforeach;?>

<?php
    ...
    $studentsubject = $class->getstudentsubjectlab();
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="form-inline form-padding">
                    <form action="classstudentlab.php?classid=<?php echo $classid;?>" method="post">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a href="data/class_model.php?q=addstudentlab&studid=<?php echo $row['id']; ?>&classid=<?php echo $classid;?>" class="btn btn-warning">Add to class</a></td>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['course']; ?></td>
                                    <td><?php echo $row['year']; ?></td>
                                    <td class="text-center"><a href="data/class_model.php?q=removestudentlab&studid=<?php echo $row['id']; ?>&classid=<?php echo $classid;?>" class="confirmation"><i class="fa fa-times-circle fa-2x text-danger"></i></a></td>
                                </tr>
                                <?php endforeach;?>

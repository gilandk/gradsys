                ...
                <div class="">
                    ...
                    <?php foreach($mystudent as $row): ?>
                        <tr>
                            ...
                            <td class="text-center"><?php echo $row['course'];?>
                            <?php if($mysubjectname['type'] == 'Lecture'): ?>
                            <?php $grade = $student->getstudentgrade($row['id'],$classid); ?>
                            <?php elseif($mysubjectname['type'] == 'Lec-Lab'): ?>
                            ...
                            <?php
                                if($grade['eqtotal']<=3.0 && ($grade['eqtotal']>=1.0) ){
                                    $remarks = 'PASSED';
                                    $class = 'text-success';
                                }elseif ($grade['eqtotal']>=3.0 && ($grade['eqtotal']<=5.0)){
                                    $remarks = 'FAILED';
                                    $class = 'text-danger';
                                } else {
                                      $remarks = 'NO GRADE';
